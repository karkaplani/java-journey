...
public interface MyConstants {
    ...
    public static final String DEFAULT_USER_PREFIX = "cst8288";
    ...
    public static final String ADDRESS_RESOURCE = "address";
    public static final String BLOOD_DONATION_RESOURCE = "blood-donation";
    public static final String BLOOD_BANK_RESOURCE = "blood-bank";
    public static final String DONATION_RECORD_RESOURCE = "donation-record";
    public static final String PHONE_RESOURCE = "phone";
    public static final String PRIVATE_BLOOD_BANK_RESOURCE = "private-blood-bank";
    public static final String PUBLIC_BLOOD_BANK_RESOURCE = "public-blood-bank";
