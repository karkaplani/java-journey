 ...
 * 
 * This class is to make the blood donation table showing on browser by automatically
 * creating a servlet by the particular URL. HTML code is used to create the table, and 
 * it is populated by the data taken from logic object.
 */
...
public class BloodDonationTableView extends HttpServlet{
    ...
    /**
     * Creating the table using HTML code. Using blood donation logic's extract data as
     * list object, all the data is gotten, and put into the blocks of a row one by one.
     * 
     * @param request
     * @param response
    ...
    public String getServletInfo() {
        return "Sample of Blood Donation View Normal";
    }
