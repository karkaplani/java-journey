...
@NamedQueries({@NamedQuery( name = BloodBank.ALL_BLOODBANKS_QUERY_NAME, query = "SELECT distinct b FROM BloodBank b left JOIN FETCH b.donations"),
	@NamedQuery( name = BloodBank.ALL_PRIVATE_BLOODBANKS_QUERY_NAME, query = "SELECT distinct b FROM PrivateBloodBank b left JOIN FETCH b.donations "),
	@NamedQuery( name = BloodBank.ALL_PUBLIC_BLOODBANKS_QUERY_NAME, query = "SELECT distinct b FROM PublicBloodBank b left JOIN FETCH b.donations")})
...
public abstract class BloodBank extends PojoBase implements Serializable {
	...
	public static final String ALL_PRIVATE_BLOODBANKS_QUERY_NAME = "PrivateBloodBank.findAll";
	public static final String ALL_PUBLIC_BLOODBANKS_QUERY_NAME = "PublicBloodBank.findAll";
