...
public class CreateDonationRecord extends HttpServlet {
    ...
    protected void processRequest( HttpServletRequest request, HttpServletResponse response )
        ...
        try( PrintWriter out = response.getWriter() ) {
            ...
            out.println( "<html>" );
            out.println( "<head>" );
            out.println( "<title>Create Blood Donation Record</title>" );
            out.println( "</head>" );
            out.println( "<body>" );
        ...
        //    out.println( "<br>" );
            ...
            out.println( "Tested:<br>" );
            out.printf( "<select name=\"%s\" value=\"\"><br>", DonationRecordLogic.TESTED);
     ...
     //       out.println( "Created:<br>" );
      //      out.printf( "<input type=\"password\" name=\"%s\" value=\"\"><br>", DonationRecordLogic.CREATED );
       //     out.println( "<br>" );
       
            out.println( "Created:<br>" );
         //   out.printf( "<input type=\"datetime-local\" name=\"%s\" value=\"\"><br>",BloodBankLogic.ESTABLISHED );
            out.printf( "<input type=\"datetime-local\" name=\"%s\" step=1 value=\"\"><br>",DonationRecordLogic.CREATED );
            out.println( "<br>" );
  ...
  //      String record = request.getParameter( DonationRecordLogic.ID );
...
//        if( drlogic.getDonationRecordWithPerson( person ) == null ){
 //           try {
//            	DonationRecord donrec = drlogic.createEntity( request.getParameterMap() );
//                drlogic.add( donrec );
//            } catch( Exception ex ) {
...
//            errorMessage = "Record: \"" + record + "\" already exists";
//        }
//        if( request.getParameter( "add" ) != null ){
//            //if add button is pressed return the same page
//            processRequest( request, response );
